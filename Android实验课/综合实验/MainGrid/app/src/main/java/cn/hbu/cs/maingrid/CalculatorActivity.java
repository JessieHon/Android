...
public class CalculatorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFan=findViewById(R.id.buttonFan);
        //为按钮添加监听器
        ...
        btnFan.setOnClickListener(onClickListener);
        btnDao.setOnClickListener(onClickListener);
    }
}